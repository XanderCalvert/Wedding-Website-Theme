...
function wedding_theme_setup() {
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'wedding_theme_custom_background_args',
			array(
...
function wedding_theme_scripts() {
	wp_enqueue_style( 'wedding-theme-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'wedding-theme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'wedding-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
